...
function App() {
  ...
  return (
    ...
    {!isSubmitted &&     <div className="wrapper">
      <img className="bg-gray-700 p-2 rounded-full" src={star} alt="star"></img>
      <h2 className="text-gray-100 text-3xl my-6">How did we do?</h2>
      <p className="text-gray-400 mb-10"> Please let us know how we did with your support request. 
